...
//     const int NUM_SAMPLES = 200;        // MUCHÍSIMO más estable
//     const int SETTLE_MS = 8;            // Tiempo que necesita el MUX
...
//         smoothed[i] = 0;
//         Serial.println("Celda tareada");
//     }

//     Serial.println("✅ Tare completa y estable.");
// }
void doTare() {
    Serial.println("🔄 Re-tareando...");
